...
public class ResultsActivity extends Activity {
    ...
    private FleetSpec loadFleetSpec(String fleetKey) {
        ...
        ShipSpec shipSpec = ShipSpec
                ...
                .setPlasmaMissiles(
                        fleetData.getInt(ShipKey.KEY_PLASMA_MISSILES))
                .setAntimatterCannons(
                        fleetData.getInt(ShipKey.KEY_ANTIMATTER_CANNONS))
    ...
    private void runSimulation() {
        ...
        setFieldValue(R.id.textResultsAttackerWinsPercent,
                percentFormat.format(simulation.attackerWinRatio()));
        setFieldValue(R.id.textResultsDefenderWinsPercent,
                percentFormat.format(simulation.defenderWinRatio()));
        setFieldValue(R.id.textResultsAttackerWins,
                Integer.toString(simulation.attackerWins()));
        setFieldValue(R.id.textResultsDefenderWins,
                Integer.toString(simulation.defenderWins()));
        setFieldValue(R.id.textResultsRounds,
                Integer.toString(simulation.totalRounds()));
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case android.R.id.home:
            ...
            return true;
        case R.id.menuItemRedoSimulation:
            simulation.resetStats();
            runSimulation();
            return true;
        case R.id.menuItemSimulateMore:
            runSimulation();
            return true;
        }
